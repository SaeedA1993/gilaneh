...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\projects\\gilaneh\\front_shop\\generated\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "E:\\projects\\gilaneh\\front_shop\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgres://neondb_owner:npg_vqW2C3nPblXB@ep-royal-cake-a2dghyd3-pooler.eu-central-1.aws.neon.tech/neondb?sslmode=require"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Post {\n  id        Int      @id @default(autoincrement())\n  title     String\n  content   String\n  published Boolean  @default(false)\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "ef4f9982d12568f7846e5e8ede2f93214e867c8d02f55b07b0edcba04b0bc14a",
  "copyEngine": true
}
